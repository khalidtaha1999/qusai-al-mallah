                ...
                <div class="col-md-offset-3 col-md-6 mt-4">
                    <div class="panel panel-default bootcards-file shadow-sm">
                        ...
                        <div class="list-group">
                            ...
                            <div class="list-group-item">
                                <p class="list-group-item-text">{{Config::get('app.locale')=='ar'?$file->description_ar:$file->description_en}}</p>
                                <a href="{{'/download/'.$file->file}}" class="btn btn-default shadow-sm mb-4"
                                   style={{Config::get('app.locale')=='ar'?'float:left':'float:right'}}>

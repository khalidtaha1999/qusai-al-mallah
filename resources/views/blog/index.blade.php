                                ...
                                <div class="col-lg-6 ">
                                    <a href="/{{Config::get('app.locale')}}/blog/{{$blog->slug}}">
                                        <article class="d-flex flex-column">
                                            <div class="post- blog_image text-center">
                                            ...
                                            <div class="meta-top">
                                                <ul class="">
                                                    <li class="d-flex align-items-center "><i class="bi bi-clock"></i>
                                                        <a>
                                                            <time>{{ \Carbon\Carbon::parse($blog->created_at)->format('j-F-Y') }}</time>
                                                        </a></li>
                                                </ul>
                                            </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="sidebar ps-lg-4 ">
                            ...
                            <div class="sidebar-item search-form">
                                <h3 class="sidebar-title">{{__('general.search')}}</h3>
                                <form action="" class="mt-3" style="direction: ltr">
                            ...
                            <div class="sidebar-item recent-posts">
                                <h3 class="sidebar-title">{{__('general.recentBlogPosts')}}</h3>
                                <div class="mt-3">
                                    @foreach($recentBlogs as $blog)
                                        <a href="/{{Config::get('app.locale')}}/blog/{{$blog->slug}}">
                                            <div class="post-item mt-3">
                                                <img src="{{asset('storage/'.$blog->image)}}" alt=""
                                                     class="flex-shrink-0 img-fluid" style="    padding-left: 5px;">
                                                <div>
                                                    <h4>
                                                        <a href="/{{Config::get('app.locale')}}/blog/{{$blog->slug}}">{{Config::get('app.locale')=='ar'?$blog->title_ar:$blog->title_en}}</a>
                                                    </h4>
                                                    <time
                                                        datetime="2020-01-01">{{ \Carbon\Carbon::parse($blog->created_at)->format('j-F-Y') }}</time>
                                                </div>
